...
class _StartExamScreenState extends State<StartExamScreen> {
    ...
    if (attempted) {
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: const Text("You cannot attempt this exam again."),
          actions: [
            TextButton(
              onPressed: () {
  ...
  Future<void> fetchQuestions() async {
    ...
    final totalMarks = examData['total_marks'] ?? 0;

    setState(() {
      questions = questionData;
      remainingSeconds = (examData['duration'] ?? 0) * 60;
      marksPerQuestion =
      questions.isNotEmpty ? totalMarks / questions.length : 0;
    });
  ...
  void submitExam() async {
    ...
    try {
      ...
      debugPrint("Insert error (likely duplicate attempt): $e");
    }
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text("Score: ${score.toStringAsFixed(1)}"),
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(context);
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // OPTIONS
              optionTile("A", q['option_a']),
              optionTile("B", q['option_b']),
              optionTile("C", q['option_c']),
              optionTile("D", q['option_d']),
  ...
  // ✅ OPTION TILE
  Widget optionTile(String key, String? text) {
    final isSelected = answers[currentIndex] == key;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? const Color(0xFF034EA1).withOpacity(0.1)
              : Colors.white,
